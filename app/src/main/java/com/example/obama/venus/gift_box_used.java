...
public class gift_box_used extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gift_box_used);
        ...
        imageButton1.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                gift_box_used.this.finish();
            }
        });

        LinearLayout gift_list = (LinearLayout)findViewById(R.id.gift_list);
        try {
            final String result = DBConnector.executeQuery("SELECT * FROM gift_box INNER JOIN gift ON gift.gift_id = gift_box.gift_id INNER JOIN shop ON gift.sh_id = shop.sh_id WHERE mb_id = '"+my_id+"' AND used = 'T' ");
            ...
            for(int i = 0; i < jsonArray.length(); i++) {
                ...
                LinearLayout gift_aaa = new LinearLayout(gift_box_used.this);
                gift_aaa.setOrientation(LinearLayout.HORIZONTAL);
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
                layoutParams.setMargins(0,30,0,0);


                LinearLayout img = new LinearLayout(gift_box_used.this);
                img.setOrientation(LinearLayout.VERTICAL);

                ImageView gift_img = new ImageView(gift_box_used.this);
                ...
                LinearLayout text = new LinearLayout(gift_box_used.this);
                ...
                TextView gift_name = new TextView(gift_box_used.this);
                ...
                TextView gift_store = new TextView(gift_box_used.this);
